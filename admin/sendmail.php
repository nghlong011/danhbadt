...
try {
    ...
    $mail->addAddress('nghlong011@gmail.com'); // Add a recipient
    ...
    // Mail body content 
    $bodyContent = '<p>Để kích hoạt tài khoản vui lòng ấn vào đây <a href = "http://localhost/danhbadt/admin/activation.php?email=nghlong011@gmail.com"></a>  </p>'; 
